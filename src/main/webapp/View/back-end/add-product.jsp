...
<link rel="icon" href="${pageContext.request.contextPath}/View/assets/images/dashboard/favicon.png"
	type="image/x-icon">
<link rel="shortcut icon" href="${pageContext.request.contextPath}/View/assets/images/dashboard/favicon.png"
	type="image/x-icon">
...
<!-- App css-->
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/View/assets/css/admin.css">
...
<body>
				...
				<div class="main-header-left d-lg-none w-auto">
					<div class="logo-wrapper">
						<a href="index.html"><img class="blur-up lazyloaded"
							src="${pageContext.request.contextPath}/View/assets/images/dashboard/multikart-logo.png" alt=""></a>
					</div>
				</div>
						...
						<li class="onhover-dropdown">
							<div class="media align-items-center">
								<img
									...
									src="${pageContext.request.contextPath}/View/assets/images/dashboard/man.png" alt="header-user">
					...
					<div class="sidebar-user text-center">
						<div>
							<img class="img-60 rounded-circle blur-up lazyloaded"
								src="${pageContext.request.contextPath}/View/assets/images/dashboard/man.png" alt="#">
						</div>
							...
							<div class="people-list friend-list">
								<ul class="list">
									<li class="clearfix"><img
										...
										src="${pageContext.request.contextPath}/View/assets/images/dashboard/user.png" alt="">
									...
									<li class="clearfix"><img
										class="rounded-circle user-image blur-up lazyloaded"
										src="${pageContext.request.contextPath}/View/assets/images/dashboard/user1.jpg" alt="">
									...
									<li class="clearfix"><img
										class="rounded-circle user-image blur-up lazyloaded"
										src="${pageContext.request.contextPath}/View/assets/images/dashboard/user2.jpg" alt="">
										<div class="status-circle online"></div>
										<div class="about">
									...
									<li class="clearfix"><img
										class="rounded-circle user-image blur-up lazyloaded"
										src="${pageContext.request.contextPath}/View/assets/images/dashboard/user3.jpg" alt="">
										<div class="status-circle online"></div>
										<div class="about">
									...
									<li class="clearfix"><img
										class="rounded-circle user-image blur-up lazyloaded"
										src="${pageContext.request.contextPath}/View/assets/images/dashboard/user5.jpg" alt="">
										<div class="status-circle away"></div>
										<div class="about">
									...
									<li class="clearfix"><img
										class="rounded-circle user-image blur-up lazyloaded"
										src="${pageContext.request.contextPath}/View/assets/images/dashboard/designer.jpg" alt="">
										<div class="status-circle online"></div>
										<div class="about">
												...
												<div class="form">
													...
													<div class="form-group mb-3 row">
														<label for="validationCustom02"
															class="col-xl-3 col-sm-4 mb-0">Guarantee :</label>
														<div class="col-xl-8 col-sm-7">
															<input class="form-control" name="guarantee"
													...
													<div class="form-group mb-3 row">
														...
														<div class="col-xl-8 col-sm-7">
															<input class="form-control" name="price"
																id="validationCustom03" type="text" required="">
														</div>
														<div class="valid-feedback">Looks good!</div>
													</div>
													<div class="form-group mb-3 row">
													...
													<div class="form-group mb-3 row">
														<label for="validationCustom05"
															class="col-xl-3 col-sm-4 mb-0">Video :</label>
														<div class="col-xl-8 col-sm-7">
															<input class="form-control" id="validationCustom05"
																name="video" type="text" required="">
														</div>
														<div class="valid-feedback">Looks good!</div>
													</div>
													<!--  
												...
												<div class="form">
													<div class="form-group row">
														<label for="exampleFormControlSelect1"
															class="col-xl-3 col-sm-4 mb-0">Select Color :</label>
													...
													<div class="form-group row">
														<label for="exampleFormControlSelect1"
															class="col-xl-3 col-sm-4 mb-0">Select Supplier :</label>
														<div class="col-xl-8 col-sm-7">
													...
													<div class="form-group row">
														<label for="exampleFormControlSelect1"
															class="col-xl-3 col-sm-4 mb-0">Select Status :</label>
														<div class="col-xl-8 col-sm-7">
													...
													<div class="form-group row">
														<label for="exampleFormControlSelect1"
															class="col-xl-3 col-sm-4 mb-0">Select Type :</label>
														<div class="col-xl-8 col-sm-7">
	...
	<!-- feather icon js-->
	<script src="${pageContext.request.contextPath}/View/assets/js/icons/feather-icon/feather.min.js"></script>
	<script src="${pageContext.request.contextPath}/View/assets/js/icons/feather-icon/feather-icon.js"></script>

	<!-- Sidebar jquery-->
	<script src="${pageContext.request.contextPath}/View/assets/js/sidebar-menu.js"></script>

	<!-- touchspin js-->
	<script src="${pageContext.request.contextPath}/View/assets/js/touchspin/vendors.min.js"></script>
	<script src="${pageContext.request.contextPath}/View/assets/js/touchspin/touchspin.js"></script>
	<script src="${pageContext.request.contextPath}/View/assets/js/touchspin/input-groups.min.js"></script>

	<!-- form validation js-->
	<script src="${pageContext.request.contextPath}/View/assets/js/dashboard/form-validation-custom.js"></script>

	<!-- ckeditor js-->
	<script src="${pageContext.request.contextPath}/View/assets/js/editor/ckeditor/ckeditor.js"></script>
	<script src="${pageContext.request.contextPath}/View/assets/js/editor/ckeditor/styles.js"></script>
	<script src="${pageContext.request.contextPath}/View/assets/js/editor/ckeditor/adapters/jquery.js"></script>
	<script src="${pageContext.request.contextPath}/View/assets/js/editor/ckeditor/ckeditor.custom.js"></script>

	<!-- Zoom js-->
	<script src="${pageContext.request.contextPath}/View/assets/js/jquery.elevatezoom.js"></script>
	<script src="${pageContext.request.contextPath}/View/assets/js/zoom-scripts.js"></script>

	<!--Customizer admin-->
	<script src="${pageContext.request.contextPath}/View/assets/js/admin-customizer.js"></script>

	<!-- lazyload js-->
	<script src="${pageContext.request.contextPath}/View/assets/js/lazysizes.min.js"></script>

	<!--right sidebar js-->
	<script src="${pageContext.request.contextPath}/View/assets/js/chat-menu.js"></script>

	<!--script admin-->
	<script src="${pageContext.request.contextPath}/View/assets/js/admin-script.js"></script>
