...
<!-- ico-font-->
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/View/assets/css/vendors/icofont.css">

<!-- Prism css-->
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/View/assets/css/vendors/prism.css">

<!-- Chartist css -->
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/View/assets/css/vendors/chartist.css">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="page-header-left">
									<h3>
										Dashboard <small>Multikart Admin panel</small>
									</h3>
								</div>
							</div>
							<div class="col-lg-6">
								...
								<div class="bg-warning card-body">
									<div class="media static-top-widget row">
										...
										<div class="media-body col-8">
											...
											<h3 class="mb-0">
												$ <span class="counter">6659</span><small> This
													Month</small>
											</h3>
										</div>
									</div>
								...
								<div class="bg-secondary card-body">
									<div class="media static-top-widget row">
										...
										<div class="media-body col-8">
											...
											<h3 class="mb-0">
												$ <span class="counter">9856</span><small> This
													Month</small>
											</h3>
										</div>
									</div>
								...
								<div class="bg-danger card-body">
									<div class="media static-top-widget row">
										...
										<div class="media-body col-8">
											...
											<h3 class="mb-0">
												$ <span class="counter">45631</span><small> This
													Month</small>
											</h3>
										</div>
									</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="user-status table-responsive latest-order-table">
										...
										<a href="order.html" class="btn btn-primary">View All
											Orders</a>
									</div>
									<div class="code-box-copy">
										<button class="code-box-copy__btn btn-clipboard"
								...
								<div class="card-header">
									...
									<div class="row">
										<div class="col-6">
											<div class="small-chartjs">
												<div class="flot-chart-placeholder"
													id="simple-line-chart-sparkline"></div>
											</div>
										</div>
										<div class="col-6">
											<div class="value-graph">
													...
													<td class="bd-t-none u-s-tb">
														<div class="align-middle image-sm-size">
															...
															<div class="d-inline-block">
																<h6>
																	John Deo <span class="text-muted digits">(14+
																		Online)</span>
																</h6>
															</div>
														</div>
												...
												<tr>
													<td class="bd-t-none u-s-tb">
														<div class="align-middle image-sm-size">
															...
															<div class="d-inline-block">
																<h6>
																	Holio Mako <span class="text-muted digits">(250+
																		Online)</span>
																</h6>
															</div>
														</div>
												...
												<tr>
													<td class="bd-t-none u-s-tb">
														<div class="align-middle image-sm-size">
															...
															<div class="d-inline-block">
																<h6>
																	Hileri Soli <span class="text-muted digits">(150+
																		Online)</span>
																</h6>
															</div>
														</div>
												...
												<tr>
													<td class="bd-t-none u-s-tb">
														<div class="align-middle image-sm-size">
															...
															<div class="d-inline-block">
																<h6>
																	Pusiz bia <span class="text-muted digits">(14+
																		Online)</span>
																</h6>
															</div>
														</div>
											...
											<div class="order-graph">
												...
												<div class="order-graph-bottom">
													<div class="media">
														...
														<div class="media-body">
															<h6 class="mb-0">
																Saint Lucia <span class="pull-right">$157</span>
															</h6>
														</div>
													</div>
													<div class="media">
													...
													<div class="media">
														...
														<div class="media-body">
															<h6 class="mb-0">
																Saint Helena <span class="pull-right">$647</span>
															</h6>
														</div>
													</div>
												</div>
...
&lt;/div&gt;</code>
	...
	<!--chartist js-->
	<script
		src="${pageContext.request.contextPath}/View/assets/js/chart/chartist/chartist.js"></script>

	<!--chartjs js-->
	<script
		src="${pageContext.request.contextPath}/View/assets/js/chart/chartjs/chart.min.js"></script>
	...
	<!--copycode js-->
	<script
		src="${pageContext.request.contextPath}/View/assets/js/prism/prism.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/View/assets/js/clipboard/clipboard.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/View/assets/js/custom-card/custom-card.js"></script>

	<!--counter js-->
	<script
		src="${pageContext.request.contextPath}/View/assets/js/counter/jquery.waypoints.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/View/assets/js/counter/jquery.counterup.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/View/assets/js/counter/counter-custom.js"></script>

	<!--peity chart js-->
	<script
		src="${pageContext.request.contextPath}/View/assets/js/chart/peity-chart/peity.jquery.js"></script>

	<!--sparkline chart js-->
	<script
		src="${pageContext.request.contextPath}/View/assets/js/chart/sparkline/sparkline.js"></script>
	...
	<!--dashboard custom js-->
	<script
		src="${pageContext.request.contextPath}/View/assets/js/dashboard/default.js"></script>
	...
	<!--height equal js-->
	<script
		src="${pageContext.request.contextPath}/View/assets/js/height-equal.js"></script>
