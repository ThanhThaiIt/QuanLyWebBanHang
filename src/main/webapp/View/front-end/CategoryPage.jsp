				...
				<div class="row">
					<div class="col-sm-3 collection-filter">
									...
									<div class="collection-brand-filter">
										...
										<div class="form-check collection-filter-checkbox">
											<input type="checkbox" class="form-check-input"
												id="vera-moda"> <label class="form-check-label"
												for="vera-moda">vera-moda</label>
										</div>
										<div class="form-check collection-filter-checkbox">
											<input type="checkbox" class="form-check-input"
												id="forever-21"> <label class="form-check-label"
							...
							<div class="collection-collapse-block border-0 open">
								...
								<div class="collection-collapse-block-content">
									<div class="collection-brand-filter">
										...
										<div class="form-check collection-filter-checkbox">
											<input type="checkbox" class="form-check-input"
												id="twohundred"> <label class="form-check-label"
												for="twohundred">m</label>
										</div>
										<div class="form-check collection-filter-checkbox">
											<input type="checkbox" class="form-check-input"
												id="threehundred"> <label class="form-check-label"
												for="threehundred">l</label>
										</div>
										<div class="form-check collection-filter-checkbox">
											<input type="checkbox" class="form-check-input"
												id="fourhundred"> <label class="form-check-label"
						...
						<div class="theme-card">
							...
							<div class="offer-slider slide-1">
								<div>
									...
									<div class="media">
										<a href=""><img class="img-fluid blur-up lazyload"
											src="${pageContext.request.contextPath}/View/assets/images/fashion/pro/011.jpg"
											alt=""></a>
										<div class="media-body align-self-center">
											<div class="rating">
												<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
									...
									<div class="media">
										<a href=""><img class="img-fluid blur-up lazyload"
											src="${pageContext.request.contextPath}/View/assets/images/fashion/pro/16.jpg"
											alt=""></a>
										<div class="media-body align-self-center">
											<div class="rating">
												<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
								...
								<div>
									<div class="media">
										<a href=""><img class="img-fluid blur-up lazyload"
											src="${pageContext.request.contextPath}/View/assets/images/fashion/pro/001.jpg"
											alt=""></a>
										<div class="media-body align-self-center">
											<div class="rating">
												<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
									...
									<div class="media">
										<a href=""><img class="img-fluid blur-up lazyload"
											src="${pageContext.request.contextPath}/View/assets/images/fashion/pro/4.jpg"
											alt=""></a>
										<div class="media-body align-self-center">
											<div class="rating">
												<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
									...
									<div class="media">
										<a href=""><img class="img-fluid blur-up lazyload"
											src="${pageContext.request.contextPath}/View/assets/images/fashion/pro/19.jpg"
											alt=""></a>
										<div class="media-body align-self-center">
											<div class="rating">
												<i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
						...
						<div class="collection-sidebar-banner">
							<a href="#"><img
								src="${pageContext.request.contextPath}/View/assets/images/side-banner.png"
