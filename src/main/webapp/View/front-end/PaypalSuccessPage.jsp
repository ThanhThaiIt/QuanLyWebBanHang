                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo">
                                <a href="IndexController"> <img src="${pageContext.request.contextPath}/View/assets/images/icon/logo.png"
...
<br/>
<br/>
<!--  a href="IndexController" style="display: inline-block; padding: 10px 20px; background-color: #ff4c3b; color: white; text-decoration: none; border-radius: 5px;">Back To Dashboard</a-->
<br/>
<br/>
<br/>
                ...
                <div class="col-lg-6">
                    <div class="product-order">
                        <div class="row product-order-detail">
                            <div class="col-3"><img src="${pageContext.request.contextPath}/View/assets/images/pro3/27.jpg" alt=""
                        ...
                        <div class="row product-order-detail">
                            <div class="col-3"><img src="${pageContext.request.contextPath}/View/assets/images/pro3/35.jpg" alt=""
                                    class="img-fluid blur-up lazyload"></div>
                            <div class="col-3 order_detail">
                                <div>
                                    <h4>product name</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li>
                                    <a href="#"><img src="${pageContext.request.contextPath}/View/assets/images/icon/visa.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="${pageContext.request.contextPath}/View/assets/images/icon/mastercard.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="${pageContext.request.contextPath}/View/assets/images/icon/paypal.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="${pageContext.request.contextPath}/View/assets/images/icon/american-express.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="${pageContext.request.contextPath}/View/assets/images/icon/discover.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
