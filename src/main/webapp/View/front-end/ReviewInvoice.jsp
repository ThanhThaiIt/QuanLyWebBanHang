        ...
        <div class="col-xl-9 m-auto">
          <div class="invoice-wrapper">
            <div class="invoice-header">
              ...
              <img src="${pageContext.request.contextPath}/View/assets/images/invoice/bg.jpg" class="img-fluid background-img w-100" alt="background">
            </div>
            ...
            <div class="invoice-footer pt-0">
              <div class="row">
                <div class="col-6">
                  <a href="#" class="btn black-btn btn-solid rounded-2" onclick="window.print();">export as PDF</a>
                </div>
