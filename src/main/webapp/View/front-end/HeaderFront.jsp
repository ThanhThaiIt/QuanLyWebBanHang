...
<script type="text/javascript">
	function deleteProduct(idProduct) {
		// href="DeleteCartController?idd=${list.getId()}"
		var xhttp;

		var url = "DeleteCartController?idd=" + idProduct;
	...
	function Search() {
		var xhttp;
		var name = document.myform.searchh.value;
		if (name != "") {

			var url = "SearchController?searchname=" + name;
			if (window.XMLHttpRequest) {
				//code for chrome, firefox, IE7+, Opera, Safari 
				xhttp = new XMLHttpRequest();
			} else {
				...
				<div class="row">
					...
					<div class="col-lg-6 text-end">
						<ul class="header-dropdown">
							...
							<%
							if (session.getAttribute("ssName") == null) {
							%>
							...
							%>
							<li class="onhover-dropdown mobile-account"><i
								class="fa fa-user" aria-hidden="true"></i> Wellcome: ${ssName}
								<ul class="onhover-show-div">
												...
												<li>
													<div class="buttons">
														<a href="cart.html" class="view-cart">view cart</a> <a
															href="CheckOutController" class="checkout">checkout</a>
													</div>
												</li>
											</ul>
										</li>
