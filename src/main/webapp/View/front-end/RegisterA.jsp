			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="theme-card">
						<form class="theme-form" action="RegisterController" method="post">


							<div class="form-row row" id="notification" class="alert d-none" role="alert">
							...
							<div class="form-row row">
								...
								<div class="col-md-6">
									<label for="review">Middle Name</label> <input type="text"
										name="mname" class="form-control" id="lname"
										placeholder="Middle Name" required="">
								</div>
								<div class="col-md-6">
									<label for="review">Last Name</label> <input type="text"
										name="lname" class="form-control" id="lname"
										placeholder="Last Name" required="">
								</div>
								<div class="col-md-6">
									<label for="email">Mobile Phone</label> <input type="text"
										name="phone" class="form-control" id="email"
								...
								<div class="form-row row">
									<div class="col-md-6">
										<label for="email">Email</label> <input type="text"
											class="form-control" name="mail" id="email"
											placeholder="Email" required="">
									</div>
									<div class="col-md-6">
										<label for="email">Password</label> <input type="password"
											class="form-control" name="pass" id="email"
											placeholder="Password" required="">
									</div>
									<div class="form-row row">
										<div class="col-md-6">
											<label for="email">Address</label> <input type="text"
												class="form-control" name="address" id="email"
												placeholder="Address" required="">
										</div>

										<button type="submit" class="btn btn-solid">Create
											Account</button>
									</div>
						</form>
					</div>
