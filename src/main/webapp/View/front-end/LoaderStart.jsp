									...
									<div class="icon-nav d-none d-sm-block">
										<ul>
											<li class="onhover-div mobile-search">
												<div>
													<img
														src="${pageContext.request.contextPath}/assets/images/icon/search.png"
											...
											<li class="onhover-div mobile-setting">
												<div>
													<img
														src="${pageContext.request.contextPath}/assets/images/icon/setting.png"
											...
											<li class="onhover-div mobile-cart">
												<div>
													<img
														src="${pageContext.request.contextPath}/assets/images/icon/cart.png"
														class="img-fluid blur-up lazyload" alt=""> <i
